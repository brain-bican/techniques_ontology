 ...
 * [bito.yml](bito.yml)
     * Determines how your purl.obolibrary.org/obo/bito/ redirects will be handled
     ...
     * Paste in the contents of [bito.yml](bito.yml)
 ...
 * [bito.md](bito.md)
     ...
     * Paste in the contents of [bito.md](bito.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
